...
const Person = ({ results, getMovieCredits }) => {
  ...
  return (
    <>
      <div className='pl-10 xl:flex xl:justify-around md:flex md:justify-around'>
        <MoviePoster posterImageURL={results.profile_path} />

        <div className='flex flex-col xl:w-8/12 md:w-6/12'>
      ...
      <div className='mt-10'>
        <h2 className='text-xl font-serif text-white leading-3 pl-10'>
          ALSO ENTERS IN
        </h2>
